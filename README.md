...
The latest release, `Overture 2024-05-16-beta.0`, is available at the following locations: 
...
#### Microsft Azure
```
https://overturemapswestus2.blob.core.windows.net/release/2024-05-16-beta.0/
 |- theme=admins
 |- theme=base
 |- theme=buildings
 |- theme=divisions
