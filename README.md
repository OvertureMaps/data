...
have organized the data for the `Overture 2023-12-14-alpha.0` release by theme and type at the following locations:
...
<table>
  ...
  <tr>
    ...
    <td>
      <ul>
        <li>Amazon S3: <code>s3://overturemaps-us-west-2/release/2023-12-14-alpha.0/theme=admins</code></li>
        <li>Microsoft Azure: <code>https://overturemapswestus2.blob.core.windows.net/release/2023-12-14-alpha.0/theme=admins</code></li>
      </ul>
    </td>
  </tr>
  <tr>
    ...
    <td>
      <ul>
        <li>Amazon S3: <code>s3://overturemaps-us-west-2/release/2023-12-14-alpha.0/theme=buildings</code></li>
        <li>Microsoft Azure: <code>https://overturemapswestus2.blob.core.windows.net/release/2023-12-14-alpha.0/theme=buildings</code></li>
      </ul>
    </td>
  </tr>
  <tr>
    ...
    <td>
      <ul>
        <li>Amazon S3: <code>s3://overturemaps-us-west-2/release/2023-12-14-alpha.0/theme=places</code></li>
        <li>Microsoft Azure: <code>https://overturemapswestus2.blob.core.windows.net/release/2023-12-14-alpha.0/theme=places</code></li>
      </ul>
    </td>
  </tr>
  <tr>
    ...
    <td>
      <ul>
        <li>Amazon S3: <code>s3://overturemaps-us-west-2/release/2023-12-14-alpha.0/theme=transportation</code></li>
        <li>Microsoft Azure: <code>https://overturemapswestus2.blob.core.windows.net/release/2023-12-14-alpha.0/theme=transportation</code></li>
      </ul>
    </td>
  </tr>
    <tr>
    ...
    <td>
      <ul>
        <li>Amazon S3: <code>s3://overturemaps-us-west-2/release/2023-12-14-alpha.0/theme=base</code></li>
        <li>Microsoft Azure: <code>https://overturemapswestus2.blob.core.windows.net/release/2023-12-14-alpha.0/theme=base</code></li>
      </ul>
    </td>
  </tr>
</table>
...
SELECT TOP 10 *
  FROM
       OPENROWSET(
           BULK 'https://overturemapswestus2.blob.core.windows.net/release/2023-12-14-alpha.0/theme=places/type=place/',
           FORMAT = 'PARQUET'
       )
  WITH
       (
...
SELECT * FROM read_parquet('s3://overturemaps-us-west-2/release/2023-12-14-alpha.0/theme=admins/type=*/*', filename=true, hive_partitioning=1);
COPY (
    SELECT
            admins.id,
            admins.subType,
...
```
Here is an example path to be passed to ```read_parquet``` method: ```azure://release/2023-12-14-alpha.0/theme=admins/type=*/*```
...
```bash
aws s3 cp --region us-west-2 --no-sign-request --recursive s3://overturemaps-us-west-2/release/2023-12-14-alpha.0/ <DESTINATION>
```
...
```bash
azcopy copy "https://overturemapswestus2.dfs.core.windows.net/release/2023-12-14-alpha.0/" "<<local directory path>>"  --recursive```
```
